 ...
 */
final class Version20211117223309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categoria (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(25) NOT NULL, descripcion LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comentario (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, noticia_id INT NOT NULL, texto LONGTEXT NOT NULL, fecha DATETIME NOT NULL, INDEX IDX_4B91E702DB38439E (usuario_id), INDEX IDX_4B91E70299926010 (noticia_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE likes (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, noticia_id INT NOT NULL, UNIQUE INDEX UNIQ_83993364DB38439E (usuario_id), UNIQUE INDEX UNIQ_8399336499926010 (noticia_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE noticia (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, categoria_id INT NOT NULL, titular VARCHAR(255) NOT NULL, entradilla LONGTEXT NOT NULL, cuerpo LONGTEXT NOT NULL, imagen VARCHAR(255) NOT NULL, fecha DATETIME NOT NULL, INDEX IDX_31205F96DB38439E (usuario_id), INDEX IDX_31205F963397707A (categoria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE post_tema (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, tema_id INT NOT NULL, texto LONGTEXT NOT NULL, fecha DATETIME NOT NULL, INDEX IDX_A8B6C233DB38439E (usuario_id), INDEX IDX_A8B6C233A64A8A17 (tema_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tema_foro (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, categoria_id INT NOT NULL, titulo_tema VARCHAR(255) NOT NULL, texto LONGTEXT NOT NULL, fecha DATETIME NOT NULL, INDEX IDX_DD05C217DB38439E (usuario_id), INDEX IDX_DD05C2173397707A (categoria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, nick VARCHAR(15) NOT NULL, password VARCHAR(255) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE likes ADD CONSTRAINT FK_83993364DB38439E FOREIGN KEY (usuario_id) REFERENCES usuario (id)');
        $this->addSql('ALTER TABLE likes ADD CONSTRAINT FK_8399336499926010 FOREIGN KEY (noticia_id) REFERENCES noticia (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE likes DROP FOREIGN KEY FK_8399336499926010');
        ...
        $this->addSql('ALTER TABLE likes DROP FOREIGN KEY FK_83993364DB38439E');
